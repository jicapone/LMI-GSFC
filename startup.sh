...
export REDUCTION="$PIPE_ADDON_ROOT/lmi_reduction/"

# add pipeline directories to python path
export PYTHONPATH=$PIPE_ADDON_ROOT/lmi_reduction:$PIPE_ADDON_ROOT/lmi_observing:$PIPE_ADDON_ROOT/lmi_photometry:$PYTHONPATH
